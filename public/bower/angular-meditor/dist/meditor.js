    ...
    link: function (scope, element, attributes, ctrl) {
      ...
      var checkSelection = function (e) {
        ...
        var newSelection = window.getSelection();
          ...
          //console.log('selection = ', JSON.stringify(newSelection.baseOffset));
      ...
      scope.SimpleAction = function(action) {
        ...
        //document.execCommand('InsertImage', true, '<img src="/public/assets/images/title.ico" />');
...
angular.module('angular-meditor').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/editor.html',
    ...
    "    <ul>\n" +
    "      <li>\n" +
    "        <button type='button' ng-click='SimpleAction(\"bold\")' title='加粗式样'>\n" +
    "          <b>粗</b>\n" +
    "        </button>\n" +
    "      </li>\n" +
    "      <li>\n" +
    "        <button type='button' ng-click='SimpleAction(\"italic\")' title='斜体式样'>\n" +
    "          <i>斜</i>\n" +
    "        </button>\n" +
    "      </li>\n" +
    "      <li>\n" +
    "        <button type='button' ng-click='SimpleAction(\"underline\")' title='下划线式样'>\n" +
    "          <ins>划</ins>\n" +
    "        </button>\n" +
    "      </li>\n" +
    "      <li>\n" +
    "        <label class='meditor-select'>\n" +
    "          <select ng-model='size' ng-options='s.value as s.label for s in sizeOptions' title='字体大小'></select>\n" +
    "        </label>\n" +
    "      </li>\n" +
    "      <li>\n" +
    "        <button type='button' ng-click='SimpleAction(\"JustifyLeft\")' title='左对齐'>\n" +
    "          <i class='fa fa-align-left'></i>\n" +
    "        </button>\n" +
    "      </li>\n" +
    "      <li>\n" +
    "        <button type='button' ng-click='SimpleAction(\"JustifyCenter\")' title='居中对齐'>\n" +
    "          <i class='fa fa-align-center'></i>\n" +
    "        </button>\n" +
    "      </li>\n" +
    "      <li>\n" +
    "        <button type='button' ng-click='SimpleAction(\"JustifyRight\")' title='右对齐'>\n" +
    "          <i class='fa fa-align-right'></i>\n" +
    "        </button>\n" +
    "      </li>\n" +
    "      <li>\n" +
    "        <button type='button' ng-click='SimpleAction(\"Indent\")' title='向右缩进'>\n" +
