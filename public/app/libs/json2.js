...
<html lang="en" class=" is-copy-enabled is-u2f-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/MzU5NDQxOTphOGJlMWM2ZWVjNmUxZDk4NzA1ODZlNzMxMWM2Y2U2Yzo1NGRlYTU5ZmZkYWE3ODY1MTNiNWYzNzA4OTAzYjhlZDI0MDM4Y2Q5ODliN2Y5NGQ3YTA3MzI2NDAxOWYyOWU5--39e85f44dea38f2b88a30c205ebdad3a360a8733">
    <meta name="pjax-timeout" content="1000">
    <link rel="sudo-modal" href="/sessions/sudo_modal">
    <meta name="request-id" content="76F92DD8:0750:BA7D31:57F4B389" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="76F92DD8:0750:BA7D31:57F4B389" name="octolytics-dimension-request_id" /><meta content="3594419" name="octolytics-actor-id" /><meta content="clarkeligong" name="octolytics-actor-login" /><meta content="aceee3cde492171199a0dff36b46d5dbca68fbabb7f7a4b54829baf86be19bb0" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="clarkeligong">

        <meta name="expected-hostname" content="github.com">
      <meta name="js-proxy-site-detection-payload" content="ODM4YTRiYTBkMDRjMzYxNWFlY2NiMWUxNjQ0ODg4NTBiNjlhOTE2ZDYxMzNjNjY5NzViZjQzMDhjYTE5MWIxNnx7InJlbW90ZV9hZGRyZXNzIjoiMTE4LjI0OS40NS4yMTYiLCJyZXF1ZXN0X2lkIjoiNzZGOTJERDg6MDc1MDpCQTdEMzE6NTdGNEIzODkiLCJ0aW1lc3RhbXAiOjE0NzU2NTQ1Mzd9">


      <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#4078c0">
      <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <meta name="html-safe-nonce" content="93570ea34b49fb432bb1d84c7ea7b4af98be3240">
    <meta content="1a7b373320ffa8201478ffca72ab2657ac7ad041" name="form-nonce" />
...
<ul class="header-nav user-nav float-right" id="user-links">
  <li class="header-nav-item">
    ...
    <a href="/notifications" aria-label="You have unread notifications" class="header-nav-link notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator" data-channel="tenant:1:notification-changed:3594419" data-ga-click="Header, go to notifications, icon:unread" data-hotkey="g n">
...
<a class="dropdown-item" href="/new" data-ga-click="Header, create new repository">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/clarkeligong"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@clarkeligong" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/3594419?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">clarkeligong</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/clarkeligong" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/clarkeligong?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
        ...
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/logout" class="logout-form" data-form-nonce="1a7b373320ffa8201478ffca72ab2657ac7ad041" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="5nRpf6DPlH2tiX5PigN5inISpZ5ozUrPdHv3+pQ2S3z9yZHEP8ULEFy/bzl7Fn2G7yQISW25USognNCejIyK5Q==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-form-nonce="1a7b373320ffa8201478ffca72ab2657ac7ad041" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="e6bcofhHoGjZcEPN7TzsNUDfNgM11KpAEVMWO7gDgO7oBCBtWSRKOajJpU0xl5oiv7xyPeUvJJZrXNNpqSKC+w==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="1092277" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/unstar" class="starred" data-form-nonce="1a7b373320ffa8201478ffca72ab2657ac7ad041" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="f3WTSgIuu5QIojFDDFrEEX9M4QI1ijcuNrrgNigz43wEe7Da1TpnupV5w2biwjmD538fC9nG1wi3xR/p8sIjKg==" /></div>
      <button
        type="submit"
        ...
        <a class="social-count js-social-count" href="/douglascrockford/JSON-js/stargazers"
           aria-label="6414 users starred this repository">
          6,414
        </a>
</form>
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/star" class="unstarred" data-form-nonce="1a7b373320ffa8201478ffca72ab2657ac7ad041" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="b3j+uNofYiyg/1rqlX7Ulwa1xEqGZXGoHoND5Gh+WCLBllZi9LWlia6vEUxPrZ9zFP5tUWcwWlflbnLZHeBZZA==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/fork" class="btn-with-count" data-form-nonce="1a7b373320ffa8201478ffca72ab2657ac7ad041" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="aWlFibftY4m7jXnbVOOeOlziJ9btNF+p+KpCC05Ukhu1vWlQy7MV4x12wOuDKGRy2fi0WVOEZ8H5dM98w7YPTQ==" /></div>
            <button
                type="submit"
    ...
    <a href="/douglascrockford/JSON-js/network" class="social-count"
       aria-label="3722 users are forked this repository">
      3,722
    </a>
  </li>
</ul>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      ...
      <a href="/douglascrockford/JSON-js/commits/master/json2.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/edit/master/json2.js" class="inline-form js-update-url-with-hash" data-form-nonce="1a7b373320ffa8201478ffca72ab2657ac7ad041" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="unPvohhI4HMuKRU3+RFBmnCMCK5hqKQ4LIpXQOp8gd5yPZAZ9WE8ZFkSHcZiUfMt+mxOFY6f975qfEGINZEmXA==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"></path></svg>
          </button>
</form>        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/delete/master/json2.js" class="inline-form" data-form-nonce="1a7b373320ffa8201478ffca72ab2657ac7ad041" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ClyuwlRMneBgjN+MFWXxyOt77XEJNU/ukaZ0uff3dR7v2iW7064TVltzZFym8bN3IveeGVXSX8n1vGhRtKFJOw==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2016 <span title="0.16013s from github-fe130-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
